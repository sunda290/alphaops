...
const PRODUTOS = [
  ...
  },
  {
    ...
    desc: 'Sessão individual de 60 minutos. Você sai com o mapa completo de automação — e o ROI calculado.',
    price: 'Gratuito',
    priceNote: 'Vagas limitadas',
    cta: 'Agendar Diagnóstico →',
    href: '#metodo',
    items: [
      'Mapeamento cirúrgico da operação',
      'Cálculo de ROI em tempo real',
      'Plano de ação personalizado',
      'Gravação da sessão',
      'Atendimento direto com André',
    ],
  },
  {
    num: '// 03',
    tag: 'Alto Ticket',
    featured: false,
    title: 'AlphaOps — Sistema Customizado',
    desc: 'Desenvolvimento sob medida que substitui trabalho manual e escala sua operação.',
    price: 'Sob consulta',
    priceNote: 'Começa pelo diagnóstico',
    cta: 'Conhecer o AlphaOps →',
    href: '/alphaops',
    items: [
...
const CAL_URL = 'https://cal.com/andre-oliveira-s290/diagnostico-estrategico'
  ...
  return (
    <>
          ...
          <div className={styles.heroInner}>
            ...
            <div className={styles.heroContent}>
              ...
              <p className={styles.heroSub}>
                Construo <strong>sistemas sob medida</strong> que eliminam o trabalho manual
                do seu negócio — usando IA e desenvolvimento Full Stack — para que você
                pare de operar e comece a crescer.
              </p>
              <div className={styles.heroBtns}>
                <a href={CAL_URL} className={styles.btnPrimary}>Quero meu Diagnóstico →</a>
            ...
            <div className={styles.heroPanel}>
              ...
              <div className={`${styles.statCard} ${styles.statCardGold}`}>
                ...
                <div className={styles.statNumber}>
                  <span style={{ color: 'var(--gold)' }}>40</span>s
                </div>
          ...
          <div className={styles.dorGrid}>
            ...
            <div>
              <div className={styles.sectionLabel}>
                <span className="mono">Reconhecimento de Terreno</span>
              </div>
              <h2 className={styles.sectionH2}>O problema<br />que você já <em>conhece</em></h2>
              <p className={styles.sectionLead}>
                Se você reconhece alguma dessas situações, sua empresa tem um problema
                sistêmico — não operacional.
              </p>
      ...
      <section className={styles.section} id="produtos">
        <div className="container">
          <div className={styles.sectionLabel}>
            <span className="mono">Soluções disponíveis</span>
          </div>
          ...
          <div className={styles.produtosGrid}>
            {PRODUTOS.map(p => (
              <div key={p.num} className={`${styles.produtoCard} ${p.featured ? styles.produtoFeatured : ''}`}>
                ...
                <ul className={styles.produtoFeatures}>
              ...
              <div className={styles.briefingBox}>
                ...
                <div style={{ marginTop: 24 }}>
                  <LeadForm
                    origem="landing_page"
                    produto="consultoria"
                    ctaText="→ Agendar minha sessão agora"
      ...
      <section className={styles.ctaFinal}>
        <div className="container" style={{ textAlign: 'center', position: 'relative', zIndex: 1 }}>
          <div className={styles.sectionLabel} style={{ justifyContent: 'center' }}>
            <span className="mono">Decisão</span>
          </div>
          <h2 className={styles.ctaH2}>
            Sua operação ainda vai<br /><em>depender de você amanhã?</em>
          </h2>
          <p className={styles.ctaSub}>
            Cada semana sem o sistema certo é mais horas dentro da operação —
            e menos tempo construindo o negócio que você quer ter.
          </p>
          <a href={CAL_URL} className={styles.btnPrimary}>Quero meu Diagnóstico Gratuito</a>
